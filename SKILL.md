...
| 同上，或问模型名称映射、各表面 ID 对照、路由名称 | `[ref:model-name-map]` | 各接入表面 Seedance 模型 ID 映射表 |
...
| 同上，需中文术语对应或确认中文表达是否地道 | `[ref:vocab/zh]` | 中文摄影机/灯光/动作/风格术语速查 |
...
| 同上，或需音频技术参数（采样率/声道/响度/同步偏移） | `[ref:audio-guide]` | 音频技术指南：支持的音频格式、时长限制、同步机制 |
